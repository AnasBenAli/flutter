                    ...
                    http.post(Uri.http(_baseUrl, "/user/signin"), headers: headers, body: json.encode(userData))
                        .then( (http.Response response) async {
                          if(response.statusCode == 200) {
                            ...
                            Database database = await openDatabase( join(await getDatabasesPath(),"gstore_esprit_database.db"),
                            ...
                            /*Map<String,dynamic> userFromServer2 = userFromServer;
                            userFromServer2["username"] = "gamix";
                            await database.update("users", userFromServer2,where: "_id= ?",whereArgs: [userFromServer["_id"]]);
                            print(userFromServer2);*/
